...
namespace CompanionDisplayWinUI
{
    ...
    /// </summary>
    public sealed partial class VoltageSensor : Page
    {
        ...
        {
            Sensors.UpdateSensorValue(sensor1, LastValue, LoadPercent, null, AppStrings.sensorsVoltage, DispatcherQueue, true);
        }
    }
}
