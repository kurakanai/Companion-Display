...
namespace CompanionDisplayWinUI
{
    ...
    /// </summary>
    public sealed partial class SmallDataSensor : Page
    {
        ...
        {
            Sensors.UpdateSensorValue(sensor1, LastValue, LoadPercent, null, AppStrings.sensorsSmallData, DispatcherQueue, false);
        }
    }
}
